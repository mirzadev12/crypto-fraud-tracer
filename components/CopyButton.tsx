...
export default function CopyButton({
  ...
  return (
    <button
      ...
      className={`inline-flex items-center gap-1 rounded-md px-1.5 py-1 text-[11px] font-medium text-faint transition hover:bg-white/5 hover:text-brand ${className}`}
    >
      {copied ? (
